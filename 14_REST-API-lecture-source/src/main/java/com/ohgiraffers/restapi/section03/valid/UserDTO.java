...
//    @NotNull(message = "아이디는 반드시 만들어져야 합니다.")
    ...
    public @NotNull(message = "아이디는 반드시 만들어져야 합니다.") String getId() {
        return id;
    }

    public void setId(@NotNull(message = "아이디는 반드시 만들어져야 합니다.") String id) {
        this.id = id;
    }
